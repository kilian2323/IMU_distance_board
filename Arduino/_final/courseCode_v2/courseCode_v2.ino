...
const unsigned int commSpeed = 100;  // [msec] Interval of sending messages to ROS node.
...
unsigned long commTime = 0;          // Holds the time when the last message was sent to the ROS node.
